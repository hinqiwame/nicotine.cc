...
public:
	void init() {
		...
		distortion.setup(XOR("low distortion"), XOR("distortion"));
...
public:
	void init() {
		...
		selection.setup(XOR("esp selection"), XOR("selection"), { XOR("players"), XOR("other") });
		RegisterElement(&selection);
		...
		health_style.AddShowCallback(callbacks::ENEMY_SELECTION);
